...
const MeetingForm: React.FC = () => {
  ...
  const handleJoinMeeting = async (e: React.FormEvent) => {
    ...
    try {
      const dados = await fetchMeeting(id, attendeeName, region);
      console.log('JoinInfo!');
      console.log(dados);

      await meetingManager
        .join({
          meetingInfo: dados.meeting,
          attendeeInfo: dados.attendee
        })
        .then(() => {
          console.log('JoinInfo.meeting', dados.meeting);
        })
        .catch(error => {
          console.log('JoinInfo.meeting', dados);
          console.log('Error join', error);
        });

      setAppMeetingInfo(id, attendeeName, region);
      console.log('setAppMeetingInfo', setAppMeetingInfo);
